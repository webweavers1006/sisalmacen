            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row no-print">
                <div class="col-12">
                  ...
                  <form id="aprueba-despacho" method="POST">
                    <input type="hidden" name="numorden" id="numorden" value="<?php echo $numorden; ?>">
                    <input type="hidden" name="deptdest" id="deptdest" value="<?php echo $deptid; ?>">
                    <button type="submit" class="btn btn-success float-right">Despachar</button>
                  </form>
                </div>
              </div>
            </div>
