        ...
        "columns": [
            ...
            { data: 'borrado' },
            {
                ...
                render: function(data, type, row) {
                    ...
                    return '<a href="javascript:;" class="btn btn-xs btn-primary Editar" style=" font-size:1px" data-toggle="tooltip" title="Editar" borrado=' + row.borrado + '   id=' + row.userid + ' > <i class="material-icons " >create</i></a>' + ' ' + '<a href="javascript:;" class="btn btn-xs btn-success Password" style=" font-size:1px" data-toggle="tooltip" title="Cambiar clave" id=' + row.userid + ' > <i class="material-icons " >https</i></a>'
